...
type AsicdExtObjClntIntf interface {
	...
	UpdateAsicGlobalPM(origCfg, newCfg *objects.AsicGlobalPM, attrset []bool, op []*clntDefs.PatchOpInfo) (bool, error)
	...
	UpdateEthernetPM(origCfg, newCfg *objects.EthernetPM, attrset []bool, op []*clntDefs.PatchOpInfo) (bool, error)
	...
	UpdateIPv4Intf(origCfg, newCfg *objects.IPv4Intf, attrset []bool, op []*clntDefs.PatchOpInfo) (bool, error)
	...
	UpdatePort(origCfg, newCfg *objects.Port, attrset []bool, op []*clntDefs.PatchOpInfo) (bool, error)
	...
	UpdateLogicalIntf(origCfg, newCfg *objects.LogicalIntf, attrset []bool, op []*clntDefs.PatchOpInfo) (bool, error)
	...
	UpdateSubIPv4Intf(origCfg, newCfg *objects.SubIPv4Intf, attrset []bool, op []*clntDefs.PatchOpInfo) (bool, error)
	...
	UpdateIPv6Intf(origCfg, newCfg *objects.IPv6Intf, attrset []bool, op []*clntDefs.PatchOpInfo) (bool, error)
	...
	UpdateSubIPv6Intf(origCfg, newCfg *objects.SubIPv6Intf, attrset []bool, op []*clntDefs.PatchOpInfo) (bool, error)
	...
	GetBufferGlobalStatState(DeviceId int32) (*objects.BufferGlobalStatState, error)
	CreateAclGlobal(cfg *objects.AclGlobal) (bool, error)
	UpdateAclGlobal(origCfg, newCfg *objects.AclGlobal, attrset []bool, op []*clntDefs.PatchOpInfo) (bool, error)
	DeleteAclGlobal(cfg *objects.AclGlobal) (bool, error)
	CreateAcl(cfg *objects.Acl) (bool, error)
	UpdateAcl(origCfg, newCfg *objects.Acl, attrset []bool, op []*clntDefs.PatchOpInfo) (bool, error)
	DeleteAcl(cfg *objects.Acl) (bool, error)
	CreateAclIpv4Filter(cfg *objects.AclIpv4Filter) (bool, error)
	UpdateAclIpv4Filter(origCfg, newCfg *objects.AclIpv4Filter, attrset []bool, op []*clntDefs.PatchOpInfo) (bool, error)
	DeleteAclIpv4Filter(cfg *objects.AclIpv4Filter) (bool, error)
	CreateAclMacFilter(cfg *objects.AclMacFilter) (bool, error)
	UpdateAclMacFilter(origCfg, newCfg *objects.AclMacFilter, attrset []bool, op []*clntDefs.PatchOpInfo) (bool, error)
	DeleteAclMacFilter(cfg *objects.AclMacFilter) (bool, error)
	CreateAclIpv6Filter(cfg *objects.AclIpv6Filter) (bool, error)
	UpdateAclIpv6Filter(origCfg, newCfg *objects.AclIpv6Filter, attrset []bool, op []*clntDefs.PatchOpInfo) (bool, error)
